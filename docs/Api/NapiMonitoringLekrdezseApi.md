# Omisai\CreditOnline\NapiMonitoringLekrdezseApi
...
| ------------- | ------------- | ------------- |
| [**dailyMonitoringGet()**](NapiMonitoringLekrdezseApi.md#dailyMonitoringGet) | **GET** /DailyMonitoring |  |
...
$apiInstance = new Omisai\CreditOnline\Api\NapiMonitoringLekrdezseApi(
...
try {
    ...
    echo 'Exception when calling NapiMonitoringLekrdezseApi->dailyMonitoringGet: ', $e->getMessage(), PHP_EOL;
}
```
